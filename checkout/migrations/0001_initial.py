...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='checkout',
            name='customer',
            field=models.ForeignKey(blank=True, to='checkout.Customer', null=True),
        ),
        migrations.AddField(
            model_name='checkout',
            name='state',
        ...
        migrations.AddField(
            model_name='checkout',
            name='user',
            field=models.ForeignKey(to=settings.AUTH_USER_MODEL, blank=True, help_text='User who created the checkout request (or blank if the the user is not logged in)', related_name='+', null=True),
        ),
